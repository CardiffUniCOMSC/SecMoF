...
public class DependencyModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case DependencyModelPackage.PARAGON: {
			Paragon paragon = (Paragon) theEObject;
			T result = caseParagon(paragon);
			if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Paragon</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Paragon</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseParagon(Paragon object) {
		return null;
	}
