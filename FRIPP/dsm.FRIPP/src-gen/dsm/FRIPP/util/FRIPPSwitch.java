 ...
 * @generated
 */
public class FRIPPSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case FRIPPPackage.PLAYBOOK_PROCESS: {
			PlaybookProcess playbookProcess = (PlaybookProcess) theEObject;
			T result = casePlaybookProcess(playbookProcess);
			if (result == null)
				result = caseProcess(playbookProcess);
			if (result == null)
		...
		case FRIPPPackage.ACTIVITY_IMPACT: {
			ActivityImpact activityImpact = (ActivityImpact) theEObject;
			T result = caseActivityImpact(activityImpact);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Playbook Process</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Playbook Process</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePlaybookProcess(PlaybookProcess object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Activity Impact</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Activity Impact</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseActivityImpact(ActivityImpact object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseProcess(dsm.PROVE.Process object) {
		return null;
	}
