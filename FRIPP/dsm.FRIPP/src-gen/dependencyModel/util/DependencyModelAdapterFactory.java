...
public class DependencyModelAdapterFactory extends AdapterFactoryImpl {
	...
	protected DependencyModelSwitch<Adapter> modelSwitch = new DependencyModelSwitch<Adapter>() {
		@Override
		public Adapter caseParagon(Paragon object) {
			return createParagonAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link dependencyModel.Paragon <em>Paragon</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createParagonAdapter() {
		return null;
	}
