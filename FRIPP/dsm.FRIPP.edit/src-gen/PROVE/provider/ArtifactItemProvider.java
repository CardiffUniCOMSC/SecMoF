...
/**
 * This is the item provider adapter for a {@link PROVE.Artifact} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArtifactItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Artifact_name_feature",
								"_UI_Artifact_type"),
						PROVEPackage.Literals.ARTIFACT__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PROVEPackage.Literals.ARTIFACT__STATE);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case PROVEPackage.ARTIFACT__NAME:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case PROVEPackage.ARTIFACT__STATE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(PROVEPackage.Literals.ARTIFACT__STATE,
				PROVEFactory.eINSTANCE.createArtifactState()));
	}
