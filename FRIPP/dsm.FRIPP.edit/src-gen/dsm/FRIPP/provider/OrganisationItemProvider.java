...
/**
 * This is the item provider adapter for a {@link dsm.FRIPP.Organisation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OrganisationItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FRIPPPackage.Literals.ORGANISATION__PLAYBOOKPROCESS);
			childrenFeatures.add(FRIPPPackage.Literals.ORGANISATION__ROLE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(FRIPPPackage.Literals.ORGANISATION__PLAYBOOKPROCESS,
				FRIPPFactory.eINSTANCE.createPlaybookProcess()));

		newChildDescriptors.add(
				createChildParameter(FRIPPPackage.Literals.ORGANISATION__ROLE, FRIPPFactory.eINSTANCE.createRole()));
	}
